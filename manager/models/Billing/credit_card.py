...
from manager.libs.utils.util_datetime import timedelta_months
...
class CreditCard(ResourceMixin, db.Model):
    ...
    def is_expiring_soon(cls, compare_date=None, exp_date=None):
        ...
        :return: bool
        """
        return exp_date <= timedelta_months(CreditCard.IS_EXPIRING_THRESHOLD_MONTHS, compare_date=compare_date)
    ...
    def mark_old_credit_cards(cls, compare_date=None):
        ...
        """
        today_with_delta = timedelta_months(CreditCard.IS_EXPIRING_THRESHOLD_MONTHS, compare_date)
